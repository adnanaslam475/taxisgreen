  ...
  if (!app.apps.length) {
    ...
    firebase = {
      ...
      driverDocsRef: (uid, timestamp) =>
        app.storage().ref(`users/${uid}/driverDocuments/${timestamp}/`),
      ...
      api: {
        ...
        fetchPlacesAutocomplete: (searchKeyword, country) =>
          fetchPlacesAutocomplete(searchKeyword, country)(firebase),
        ...
        getRouteDetails: (startLoc, destLoc) =>
          getRouteDetails(startLoc, destLoc)(firebase),
        getDriveTime: (startLoc, destLoc) =>
          getDriveTime(startLoc, destLoc)(firebase),
        getMultiLocTime: (startLoc, destLoc, waypoints) =>
          getMultiLocTime(startLoc, destLoc, waypoints)(firebase),
        ...
        fetchUsersOnce: () => (dispatch) =>
          fetchUsersOnce()(dispatch)(firebase),
        ...
        updateMessagesToRead: (data) => (dispatch) =>
          updateMessagesToRead(data)(dispatch)(firebase),
        ...
        fetchLanguages: () => (dispatch) =>
          fetchLanguages()(dispatch)(firebase),
      },
    };
  }
