...
export const addBooking = (bookingData) => (dispatch) => async (firebase) => {
  const { bookingRef, appcat, settingsRef } = firebase;
  ...
  var data = {
    ...
    carExtraInfo: bookingData.carDetails.extra_info,
    ...
    customer_stripe_customer_id:
      bookingData.userDetails.profile.stripeCustomerId,
    customer_name:
    ...
    status:
      appcat == "taxi" || bookingData.booking_type_admin
        ? "NEW"
        : "PAYMENT_PENDING",
    bookLater: bookingData.bookLater,
    paymentMethodModalId: bookingData.paymentMethodModalId,
