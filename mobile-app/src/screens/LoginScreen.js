      ...
      >
        ...
        <View style={styles.topBar}>
          <TouchableOpacity
            style={[
              styles.backButton,
              { alignSelf: isRTL == true ? "flex-end" : "flex-start" },
            ]}
            onPress={() => {
        ...
        {state.customStyleIndex == 0 ? (
          <View style={{ marginTop: 10 }}>
            <TouchableOpacity
              style={{ fontSize: 18, fontWeight: "bold", marginLeft: 40 }}
        ...
        {state.customStyleIndex != 0 ? (
          state.verificationId ? null : (
            <View style={styles.linkBar}>
              <TouchableOpacity style={styles.barLinks} onPress={onPressLogin}>
                <Text
                  style={[
                    styles.linkText,
                    {
...
const styles = StyleSheet.create({
  ...
  imagebg: {
    ...
    height:
      Dimensions.get("window").height + (Platform.OS == "android" ? 40 : 0),
  },
  topBar: {
    marginTop: 0,
    marginLeft: 0,
