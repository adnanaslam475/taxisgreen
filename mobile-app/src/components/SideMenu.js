...
export default function SideMenu(props) {
  ...
  const sideMenuList = [
    ...
    },
    {
      ...
      icon: appcat == "delivery" ? "truck-fast" : "directions",
    ...
    <View style={styles.mainViewStyle}>
      ...
      <View style={styles.compViewStyle}>
        <View
          style={[
            styles.vertialLine,
            { height: width <= 320 ? width / 1.32 : width / 1.4 },
          ]}
        ></View>
        {!!settings ? (
          <FlatList
            ...
            style={{ marginTop: 75, width: "95%", padding: 5 }}
            bounces={false}
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      {
                        marginTop:
                          index == sideMenuList.length - 1 ? width / 21 : 0,
                      },
                    ]}
                  >
                    <View style={styles.viewIcon}>
